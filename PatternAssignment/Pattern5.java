...
public class Pattern5 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            // S
            for (int j = 0; j < n; j++) {
                if (i == 0 && j > 1 && j < (n - 1) / 2 || i == (n - 1) / 2 && j > 1 && j < (n - 3) / 2
                        || i == n - 1 && j < (n - 3) / 2 && j > 0 || j == 0 && i > 1 && i < (n - 3) / 2
                        || j == (n - 1) / 2 && i > (n + 1) / 2 && i < n - 2 || i == 1 && j == 1
                        || j == (n - 3) / 2 && (i == n - 2 || i == (n + 1) / 2) || j == 0 && i == n - 2
                        || j == (n - 1) / 2 && i == 1 || j == 1 && i == (n - 3) / 2) {
                    System.out.print("* ");
                } else {
                    System.out.print("  ");
                }
        ...
        for (int i = 0; i < n; i++) {
            ...
            // j
            for (int j = 0; j < n; j++) {
                if (i == 0 && j < (n - 1) / 2 || i == n - 1 && j > 0 && j < (n - 3) / 4 || j == (n - 1) / 4 && i < n - 1
                        || j == 0 && i < n - 1 && i > (n + 3) / 2) {
                    System.out.print("* ");
                } else {
                    System.out.print("  ");
